...
<f:view>
	...
	<h:form id="frm" styleClass="centerPage">
		...
		<h:outputText styleClass="msgErro" value="Não há resultado disponível!" rendered="#{consultaResultadoBean.resultadoUsuario==null || !consultaResultadoBean.resultadoAvaiable}"/>	
